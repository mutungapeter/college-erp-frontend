...
export type ApplicationDocumentCreate = z.infer<
  typeof applicationDocumentCreateSchema
>;
export type ApplicationDocumentUpdate = z.infer<
  typeof applicationDocumentUpdateSchema
>;
