...
export const bookCreateSchema = z.object({
  ...
  author: z.string().min(1, "Authoer is required").max(100, "Author must be less than 100 characters"),
...
export type UpdateIssuedBookStatusType = z.infer<typeof UpdateIssuedBookStatusSchema>;
