...
const hostelBaseSchema = z.object({
  ...
  rooms: z.coerce
    .number()
    .min(1, 'Rooms should be greater than 0')
    .max(10000)
    .nullable()
    .optional(),
  room_cost: z.coerce
    .number()
    .min(0, "Rooms cost can't be a negative value")
    .max(50000)
    .nullable()
    .optional(),
  capacity: z.coerce
...
export const HostelRoomBookingCreateSchema =
  hostelRoomBookinBaseSchema.required();
...
export const HostelRoomBookingUpdateSchema =
  hostelRoomBookinBaseSchema.partial();
...
export type HostelRoomBookingCreateType = z.infer<
  typeof HostelRoomBookingCreateSchema
>;
export type HostelRoomBookingUpdateType = z.infer<
  typeof HostelRoomBookingUpdateSchema
>;
...
export type UpdateRoomBookingStatusType = z.infer<
