...
const payrollBaseSchema = z.object({
  nhif_number: z
    .string()
    .min(1, 'Nhif is required')
    .max(200)
    .nullable()
    .optional(),
  nssf_number: z
    .string()
    .min(1, 'Nssf is required')
    .max(200)
    .nullable()
    .optional(),
  kra_pin: z
  ...
  basic_salary: z.coerce
    ...
    .nullable()
    .optional(),
  house_allowance: z.coerce
    .number()
    .min(0, 'Value be less than 0')
    .max(5000000)
    .nullable()
    .optional(),
  transport_allowance: z.coerce
    .number()
    .min(0, 'Value cannot be less than 0')
    .max(10000000)
    .nullable()
    .optional(),
  other_allowances: z.coerce
    .number()
    .min(0, 'Value cannot be less than 0')
    .max(10000000)
    .nullable()
...
export type StaffDocumentMultiCreate = z.infer<
  typeof staffDocumentMultiCreateSchema
>;
