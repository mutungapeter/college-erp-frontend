    ...
    <>
      {isRedirecting ? (
        ...
        <div className="min-h-screen flex">
          <div
            className="hidden lg:flex lg:w-1/2 h-screen bg-cover bg-center"
          ...
          >
            <div className="relative z-10 flex flex-col justify-center items-center text-center px-12 text-white">
              <h2 className="text-4xl font-semibold mb-6 text-blue-100 drop-shadow-lg">
                Maweng College
              </h2>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
            <div className="relative z-20  w-full md:max-w-c-400">
              <div
