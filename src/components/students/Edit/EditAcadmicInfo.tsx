                      ...
                      <div className="ml-3 flex-1">
                        <div className="flex justify-between items-start">
                          <p className="text-sm font-medium text-amber-800">
                            Changing cohort transfers the student to a new
                            program
                          </p>
                          <button
                            type="button"
                        ...
                        {isExpandedNote && (
                          <div className="mt-2 text-sm text-amber-700">
                            <p>Editing a student&apos;s cohort will:</p>
                            <ul className="list-disc pl-5 mt-1 space-y-1">
                              <li>
                                Transfer the student to the new program
                                associated with the cohort
                              </li>
                              <li>
                                Change all units the student is enrolled in
                              </li>
                              <li>
                                Potentially affect grading and academic
                                progression
                              </li>
