...
import { useDeleteFinAccountMutation, useGetAccountsQuery } from "@/store/services/finance/accounting";
...
const ChartOfAccounts = () => {
  ...
  const searchParams = useSearchParams();
   const [isDeleteModalOpen, setIsDeleteModalOpen] = useState(false);
    ...
    const [deleteFinAccount, { isLoading: isDeleting }] = useDeleteFinAccountMutation();
    ...
    const handleDeleteFinAccount = async () => {
      try {
        ...
        if (error && typeof error === "object" && "data" in error && error.data) {
          ...
          toast.error(errorData.error || "Error moving Account to archieved folder!.");
        } else {
