  ...
  const financialReportsList = [
    {
      ...
      description: "Shows your college's net income and summarizes your tuition fees, grants, and operational expenses in a given time period.",
      link: "/dashboard/accounts/reports/income-statement"
    },
    {
      title: "Balance Sheet",
      description: "A snapshot of your college's finances on a given day. The balance sheet calculates your institution's net worth (equity) by subtracting what you owe (liabilities) from what you own (assets).",
      link: "/dashboard/accounts/reports/balance-sheet"
    },
    {
      title: "Cash Flow",
      description: "Shows how much money is entering and leaving your college over a specific period, divided into academic operations, infrastructure investments, and funding activities.",
    ...
    <div className="w-full font-nunito">
      ...
      <div className="w-full grid grid-cols-1 gap-5 md:grid-cols-2 bg-white p-6 rounded-md">
        <div className="flex flex-col gap-5">
          <h2 className="text-2xl font-medium text-gray-900">Financial Reports</h2>
          <p className="text-sm font-normal text-gray-600">
            Get a clear picture of how your college is doing. Use these core
            statements to better understand your institution&apos;s financial health.
          </p>
        </div>
