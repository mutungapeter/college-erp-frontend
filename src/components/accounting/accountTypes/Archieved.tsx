  ...
  return (
    <div className=" w-full ">
      ...
      <ActionModal
        ...
        confirmationMessage="Are you sure you want to unarchive this account type?"
        deleteMessage="This account Type will be unarchived and moved to active accounts section."
        title="Unarchievd Account Type"
        actionText="Unarchieve"
        actionType="submit"
      />
    </div>
  );
...
export default ArchievedAccountTypes;
