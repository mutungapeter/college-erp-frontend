...
const EditFeeStructure = ({ refetchData, data }: Props) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      year_of_study: data?.year_of_study.id ?? undefined,
      ...
      {isOpen && (
        ...
        >
          <div
            ...
            bg-opacity-50 transition-opacity animate-fadeIn cursor-pointer"
            aria-hidden="true"
          />
