...
import { useGetPositionsQuery, useUpdateStaffMutation } from "@/store/services/staff/staffService";
  ...
  const onSubmit = async (formData: UpdateStaffType) => {
    ...
    try {
      ...
      if (error && typeof error === "object" && "data" in error && error.data) {
        ...
        setIsError(true);
        setSuccessMessage("An error occured while updating Work Info. Please try again!.");
        setShowSuccessModal(true);
      } else {
        setIsError(true);
                  ...
                  <div className="ml-3 flex-1">
                    <div className="flex justify-between items-start">
                      <p className="text-sm font-medium text-amber-800">
                        Changing department transfers the staff to a new Department and updates their position.
                      </p>
                      <button 
                        type="button"
                    ...
                    {isExpandedNote && (
                      <div className="mt-2 text-sm text-amber-700">
                        <p>
                          Editing a staff&apos;s department will:
                        </p>
                        <ul className="list-disc pl-5 mt-1 space-y-1">
                          <li>Transfer the staff to the new department</li>
                          <li>Potentially affect their responsibilities and reporting structure</li>
                ...
                >
                  <div>
                      <div className="relative">
                        ...
                        <Select
                          options={departmentsData?.map((department: DepartmentType) => ({
                            value: department.id,
