    ...
    <>
      <div className="bg-white w-full  p-1 shadow-md rounded-lg font-nunito">
        ...
        <div className="flex flex-col gap-4 mt-5 lg:gap-0 md:gap-0 lg:flex-row md:flex-row  md:items-center p-2 md:justify-between lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col gap-2  lg:p-0 lg:flex-row md:flex-row md:items-center md:space-x-2 lg:items-center lg:space-x-5">
            <FilterSelect
        ...
        ) : reportingData && reportingData.results.length > 0 ? (
          <DataTable
            data={reportingData?.results}
            columns={columns}
            isLoading={isLoading}
            error={error}
          />
        ...
        {reportingData && reportingData.count > 0 && (
          <Pagination
            currentPage={currentPage}
            totalItems={reportingData.count}
            pageSize={PAGE_SIZE}
