...
const PayVendor = ({ refetchData }: Props) => {
              ...
              <>
                ...
                >
                  <div>
                    ...
                    <Select
                      options={data?.map((item: AwardedTenderType) => ({
                        value: item.id,
                        label: `${item.tender.title}(${item.vendor.name} ${item.vendor.vendor_no})`,
                      }))}
                      ...
                      onChange={handleTenderAwardChange}
                    />

                    {errors.tender_award && (
                      <p className="text-red-500 text-sm mt-1">
                        {errors.tender_award.message}
                      </p>
                    )}
                  </div>
