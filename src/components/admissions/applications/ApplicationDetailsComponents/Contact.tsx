...
const ContactAddressCard = ({ applicationDetails }: ContactAddressCardProps) => {
  return (
    <div className="space-y-4 p-5 border rounded-lg shadow-sm hover:shadow-md transition-shadow">
      <div className="flex items-center gap-2 border-b pb-3">
        ...
        <h3 className="text-lg font-semibold text-gray-800">Contact & Address</h3>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="border-t pt-3 mt-3">
          ...
          <p className="text-gray-800">
            ...
            {applicationDetails.postal_code && `, ${applicationDetails.postal_code}`}
            <br />
